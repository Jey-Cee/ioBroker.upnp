...
function main(id, state) {
    ...
    try {
        ...
        adapter.log.error('Cannot control player: ' + e);
    }
}
...
function play(playerID) {
    ...
    addTask({name: 'setState', id: playerID + '.MediaRenderer.AVTransport.SetAVTransportURI.request', state: 'true'});*/
    ...
    setTimeout(() => {
        ...
        addTask({name: 'setState', id: playerID + '.MediaRenderer.AVTransport.Play.request', state: true});
        processTasks();
    }, 15);
...
function pause(playerID) {
    ...
    addTask({name: 'setState', id: playerID + '.MediaRenderer.AVTransport.Pause.request', state: true});
    processTasks();
    setTimeout(() => {
...
function stop(playerID) {
    ...
    addTask({name: 'setState', id: playerID + '.MediaRenderer.AVTransport.Stop.request', state: true});
    processTasks();
...
function mute(playerID) {
    ...
    addTask({name: 'setState', id: playerID + '.MediaRenderer.RenderingControl.GetMute.request', state: true});
    processTasks();
    setTimeout(() => {
        adapter.getState(playerID + '.MediaRenderer.RenderingControl.Mute', (err, state) => {
            ...
            if (!oldMute) {
                ...
                addTask({name: 'setState', id: playerID + '.MediaRenderer.RenderingControl.SetMute.request', state: true});
            } else {
                addTask({name: 'setState', id: playerID + '.MediaRenderer.RenderingControl.SetMute.InstanceID', state: 0});
                addTask({name: 'setState', id: playerID + '.MediaRenderer.RenderingControl.SetMute.Channel', state: 'Master'});
...
function volume_up(playerID) {
    ...
    addTask({name: 'setState', id: playerID + '.MediaRenderer.RenderingControl.GetVolume.request', state: true});
    processTasks();
    setTimeout(() => {
        adapter.getObject(playerID + '.MediaRenderer.RenderingControl.Volume', (err, obj) => {
            ...
            adapter.getState(playerID + '.MediaRenderer.RenderingControl.Volume', (err, state) => {
                ...
                addTask({name: 'setState', id: playerID + '.MediaRenderer.RenderingControl.SetVolume.request', state: true});
                processTasks();
                setTimeout(() => {
...
function randomPlay(playerID) {
    ...
    addTask({name: 'setState', id: playerID + '.MediaRenderer.AVTransport.SetPlayMode.request', state: true});
    processTasks();
    setTimeout(() => {
