...
/**
 * Represents a subscription to an event-based service.
 * Allows managing initialization, resubscription, and unsubscription.
 *
 * @param {string} host The host address of the service to subscribe to.
 * @param {number} port The port number of the service to connect to.
 * @param {string} eventSub The event subscription path of the service.
 * @param {number} [requestedTimeoutSeconds] The requested timeout duration for the subscription in seconds.
